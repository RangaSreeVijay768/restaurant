...
import 'user_accounts_signin_form_controller.dart';
import 'user_accounts_signin_form_cubit.dart';

import '/app/core/widgets/base_stateless_widget.dart';

class UserAccountsSigninForm
    extends BaseFormStatelessWidget<
        UserAccountsSigninFormController,
        UserAccountsSigninFormCubit,
        UserAccountsSigninFormState> {

  UserAccountsSigninForm({Key? key, super.controller, super.onStateChanged})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<UserAccountsSigninFormCubit>(
  ...
  @override
  UserAccountsSigninFormCubit createCubitAndAssignToController(
      BuildContext context) {
    UserAccountsSigninFormCubit cubit = UserAccountsSigninFormCubit(
        context: context);
