...
abstract class borders {
  static Border b_1px_grey05 = Border.all(color: AppColors.grey05, width: 1);
  ...
  static Border b_1px_red = Border.all(color: AppColors.textRed , width: 1);
  static Border b_1px_orange = Border.all(color: AppColors.orange , width: 1);
  ...
  static Border bb_1px_grey05 = const Border(
      bottom: BorderSide(
